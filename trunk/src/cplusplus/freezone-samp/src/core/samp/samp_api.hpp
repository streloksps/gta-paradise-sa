...
namespace samp {
    class api
        ...
        ,public on_pre_pre_gamemode_init_i
        ,public on_post_post_gamemode_exit_i
    {
    public:
        typedef std::tr1::shared_ptr<api> ptr;
        static ptr instance();
    ...
    public: // on_pre_pre_gamemode_init_i
        virtual void on_pre_pre_gamemode_init(AMX* amx, samp::server_ver ver);
    ...
    public:
        ...
        int get_invalid_player_id() const;
        // Misc
        enum {MAX_PLAYER_NAME               = 24};
        enum {MAX_PLAYERS                   = 200};
        enum {MAX_VEHICLES                  = 700};
        enum {INVALID_PLAYER_ID_02X         = 255};
        enum {INVALID_PLAYER_ID_030         = 0xFFFF};
        enum {INVALID_VEHICLE_ID            = 0xFFFF};
        enum {NO_TEAM                       = 255};
        enum {MAX_OBJECTS                   = 150};
        enum {INVALID_OBJECT_ID             = 255};
        enum {MAX_GANG_ZONES                = 1024};
        enum {MAX_TEXT_DRAWS                = 1024};
        enum {MAX_MENUS                     = 128};
        ...
        enum {MAX_PLAYER_NAME_v030          = 24};
        enum {MAX_PLAYERS_v030              = 500};
        enum {MAX_VEHICLES_v030             = 2000};
        enum {INVALID_PLAYER_ID_v030        = 0xFFFF};
        enum {INVALID_VEHICLE_ID_v030       = 0xFFFF};
        enum {NO_TEAM_v030                  = 255};
        enum {MAX_OBJECTS_v030              = 254};
        enum {INVALID_OBJECT_ID_v030        = 255};
        enum {MAX_GANG_ZONES_v030           = 1024};
        enum {MAX_TEXT_DRAWS_v030           = 2048};
        enum {MAX_MENUS_v030                = 128};
        enum {MAX_3DTEXT_GLOBAL_v030        = 1024};
        enum {MAX_3DTEXT_PLAYER_v030        = 1024};
        enum {MAX_PICKUPS_v030              = 2048};
        enum {INVALID_MENU_v030             = 0xFF};
        enum {INVALID_TEXT_DRAW_v030        = 0xFFFF};
        enum {INVALID_GANG_ZONE_v030        = -1};
        enum {INVALID_3DTEXT_ID_v030        = 0xFFFF};
        enum {MAX_CHATBUBBLE_LENGTH_v030    = 144};
        ...
        // a_objects.inc
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        int     create_object(int model_id, float x, float y, float z, float rx, float ry, float rz, float draw_distance); // CreateObject(modelid, Float:X, Float:Y, Float:Z, Float:rX, Float:rY, Float:rZ, Float:DrawDistance = 0.0);
        ...
        int     create_player_object(int player_id, int model_id, float x, float y, float z, float rx, float ry, float rz, float draw_distance); // CreatePlayerObject(playerid, modelid, Float:X, Float:Y, Float:Z, Float:rX, Float:rY, Float:rZ, Float:DrawDistance = 0.0);
        ...
        int     create_player3dtextlabel(int player_id, std::string const& text, unsigned int color, float x, float y, float z, float draw_distance, int attached_player_id = INVALID_PLAYER_ID_v030, int attached_vehicle_id = INVALID_VEHICLE_ID_v030, bool is_test_los = true); // PlayerText3D:CreatePlayer3DTextLabel(playerid, text[], color, Float:X, Float:Y, Float:Z, Float:DrawDistance, attachedplayer=INVALID_PLAYER_ID, attachedvehicle=INVALID_VEHICLE_ID, testLOS=0);
    ...
    public:
        ...
        server_ver get_ver() const;
        bool is_has_022_features() const;
        bool is_has_030_features() const;

    private:
        void dump_marhs() const;
    };
} // namespace samp {
#endif // SAMP_API_HPP
