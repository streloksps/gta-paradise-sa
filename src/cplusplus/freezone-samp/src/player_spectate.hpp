...
private:
    ...
    // ¬ќзращает истину, если выполнена успешно
    ...
    // ¬озращает первого игрока дл€ наблюдени€ или 0, если не удалось найти таких
...
public:
    ...
    player_ptr_t get_spectate_to(); // ¬озращает игрока, за кем следит данный игрок
...
private: // —осто€ние перед спеком
    ...
    // ¬озращает истину, если данный игрок может следить за кем то
